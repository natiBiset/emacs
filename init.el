...
(custom-set-variables
 ...
 '(package-selected-packages
   '(direnv html-mode html-ls lsp-treemacs flycheck lsp-pyright lsp-ivy lsp-ui lsp-mode projectile djvu nov nov\.el magit company-box company counsel org-noter-pdftools pdf-tools undo-fu zenburn-theme powerline which-key use-package try org-superstar org-bullets)))
(custom-set-faces
